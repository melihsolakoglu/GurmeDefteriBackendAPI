...
class CategorizeUnscoredPaginationSource(private val userId:String,
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Food> {
        return try {
            ...
            val response = repository.getUnscoredCategorizeFoodsByPageWithUserId(userId,queryKey,currentPage, 4)
